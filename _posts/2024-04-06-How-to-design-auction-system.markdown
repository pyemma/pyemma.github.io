...
tags: [system design, auction, realtime system]
toc: true
---
...
![Auction Database](/assets/auction_db.png){: width="700" height="400" }
...
![Auction Bid Execution](/assets/auction_bid_execution.png){: width="700" height="400" }
...
![Stateless Architecture](/assets/auction_all.png){: width="700" height="400" }
...
![Stateful Architecture](/assets/auction_stateful.png){: width="700" height="400" }
...
{% include embed/youtube.html id='85uigxGitIg' %}
